...
//
// Solidity: function getHistory(uint256 _offset, uint256 _limit) view returns((bool,uint256,uint256,uint256,uint256,uint256,uint256,address)[])
...
//
// Solidity: function history(uint256 ) view returns(bool _goodCloseout, uint256 _purchaseTime, uint256 _endTime, uint256 _price, uint256 _fee, uint256 _speed, uint256 _length, address _buyer)
func (_Implementation *ImplementationCaller) History(opts *bind.CallOpts, arg0 *big.Int) (struct {
	...
	outstruct.Speed = *abi.ConvertType(out[5], new(*big.Int)).(**big.Int)
	outstruct.Length = *abi.ConvertType(out[6], new(*big.Int)).(**big.Int)
