...
// SetUpdateContractInformation is a paid mutator transaction binding the contract method 0x8e1f1ced.
//
// Solidity: function setUpdateContractInformation(address _contractAddress, uint256 _price, uint256 _limit, uint256 _speed, uint256 _length, int8 _profitTarget) returns()
func (_Clonefactory *ClonefactoryTransactor) SetUpdateContractInformation(opts *bind.TransactOpts, _contractAddress common.Address, _price *big.Int, _limit *big.Int, _speed *big.Int, _length *big.Int, _profitTarget int8) (*types.Transaction, error) {
	return _Clonefactory.contract.Transact(opts, "setUpdateContractInformation", _contractAddress, _price, _limit, _speed, _length, _profitTarget)
}

// SetUpdateContractInformation is a paid mutator transaction binding the contract method 0x8e1f1ced.
//
// Solidity: function setUpdateContractInformation(address _contractAddress, uint256 _price, uint256 _limit, uint256 _speed, uint256 _length, int8 _profitTarget) returns()
func (_Clonefactory *ClonefactorySession) SetUpdateContractInformation(_contractAddress common.Address, _price *big.Int, _limit *big.Int, _speed *big.Int, _length *big.Int, _profitTarget int8) (*types.Transaction, error) {
	return _Clonefactory.Contract.SetUpdateContractInformation(&_Clonefactory.TransactOpts, _contractAddress, _price, _limit, _speed, _length, _profitTarget)
}

// SetUpdateContractInformation is a paid mutator transaction binding the contract method 0x8e1f1ced.
//
// Solidity: function setUpdateContractInformation(address _contractAddress, uint256 _price, uint256 _limit, uint256 _speed, uint256 _length, int8 _profitTarget) returns()
func (_Clonefactory *ClonefactoryTransactorSession) SetUpdateContractInformation(_contractAddress common.Address, _price *big.Int, _limit *big.Int, _speed *big.Int, _length *big.Int, _profitTarget int8) (*types.Transaction, error) {
	return _Clonefactory.Contract.SetUpdateContractInformation(&_Clonefactory.TransactOpts, _contractAddress, _price, _limit, _speed, _length, _profitTarget)
}
