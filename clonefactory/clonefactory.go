...
//
// Solidity: function initialize(address _baseImplementation, address _hashrateOracle, address _paymentToken, address _feeToken, uint256 _validatorFeeRateScaled, uint256 _minSellerStake) returns()
func (_Clonefactory *ClonefactoryTransactor) Initialize(opts *bind.TransactOpts, _baseImplementation common.Address, _hashrateOracle common.Address, _paymentToken common.Address, _feeToken common.Address, _validatorFeeRateScaled *big.Int, _minSellerStake *big.Int) (*types.Transaction, error) {
	return _Clonefactory.contract.Transact(opts, "initialize", _baseImplementation, _hashrateOracle, _paymentToken, _feeToken, _validatorFeeRateScaled, _minSellerStake)
}

// Initialize is a paid mutator transaction binding the contract method 0xd7c41c79.
//
// Solidity: function initialize(address _baseImplementation, address _hashrateOracle, address _paymentToken, address _feeToken, uint256 _validatorFeeRateScaled, uint256 _minSellerStake) returns()
func (_Clonefactory *ClonefactorySession) Initialize(_baseImplementation common.Address, _hashrateOracle common.Address, _paymentToken common.Address, _feeToken common.Address, _validatorFeeRateScaled *big.Int, _minSellerStake *big.Int) (*types.Transaction, error) {
	return _Clonefactory.Contract.Initialize(&_Clonefactory.TransactOpts, _baseImplementation, _hashrateOracle, _paymentToken, _feeToken, _validatorFeeRateScaled, _minSellerStake)
}

// Initialize is a paid mutator transaction binding the contract method 0xd7c41c79.
//
// Solidity: function initialize(address _baseImplementation, address _hashrateOracle, address _paymentToken, address _feeToken, uint256 _validatorFeeRateScaled, uint256 _minSellerStake) returns()
func (_Clonefactory *ClonefactoryTransactorSession) Initialize(_baseImplementation common.Address, _hashrateOracle common.Address, _paymentToken common.Address, _feeToken common.Address, _validatorFeeRateScaled *big.Int, _minSellerStake *big.Int) (*types.Transaction, error) {
	return _Clonefactory.Contract.Initialize(&_Clonefactory.TransactOpts, _baseImplementation, _hashrateOracle, _paymentToken, _feeToken, _validatorFeeRateScaled, _minSellerStake)
}
