...
func (_Clonefactory *ClonefactoryCaller) VALIDATORFEEMULT(opts *bind.CallOpts) (uint16, error) {
	var out []interface{}
	err := _Clonefactory.contract.Call(opts, &out, "VALIDATOR_FEE_MULT")
...
//
// Solidity: function VALIDATOR_FEE_MULT() view returns(uint16)
func (_Clonefactory *ClonefactorySession) VALIDATORFEEMULT() (uint16, error) {
	return _Clonefactory.Contract.VALIDATORFEEMULT(&_Clonefactory.CallOpts)
}

// VALIDATORFEEMULT is a free data retrieval call binding the contract method 0x444b5c73.
//
// Solidity: function VALIDATOR_FEE_MULT() view returns(uint16)
func (_Clonefactory *ClonefactoryCallerSession) VALIDATORFEEMULT() (uint16, error) {
	return _Clonefactory.Contract.VALIDATORFEEMULT(&_Clonefactory.CallOpts)
}
...
func (_Clonefactory *ClonefactoryCaller) ValidatorFeeRateScaled(opts *bind.CallOpts) (uint16, error) {
	var out []interface{}
...
//
// Solidity: function validatorFeeRateScaled() view returns(uint16)
func (_Clonefactory *ClonefactorySession) ValidatorFeeRateScaled() (uint16, error) {
...
//
// Solidity: function validatorFeeRateScaled() view returns(uint16)
func (_Clonefactory *ClonefactoryCallerSession) ValidatorFeeRateScaled() (uint16, error) {
	return _Clonefactory.Contract.ValidatorFeeRateScaled(&_Clonefactory.CallOpts)
}
...
//
// Solidity: function initialize(address _baseImplementation, address _lumerin, address _feeRecipient, uint16 _validatorFeeRateScaled) returns()
func (_Clonefactory *ClonefactoryTransactor) Initialize(opts *bind.TransactOpts, _baseImplementation common.Address, _lumerin common.Address, _feeRecipient common.Address, _validatorFeeRateScaled uint16) (*types.Transaction, error) {
	return _Clonefactory.contract.Transact(opts, "initialize", _baseImplementation, _lumerin, _feeRecipient, _validatorFeeRateScaled)
}

// Initialize is a paid mutator transaction binding the contract method 0x2e112757.
//
// Solidity: function initialize(address _baseImplementation, address _lumerin, address _feeRecipient, uint16 _validatorFeeRateScaled) returns()
func (_Clonefactory *ClonefactorySession) Initialize(_baseImplementation common.Address, _lumerin common.Address, _feeRecipient common.Address, _validatorFeeRateScaled uint16) (*types.Transaction, error) {
	return _Clonefactory.Contract.Initialize(&_Clonefactory.TransactOpts, _baseImplementation, _lumerin, _feeRecipient, _validatorFeeRateScaled)
}

// Initialize is a paid mutator transaction binding the contract method 0x2e112757.
//
// Solidity: function initialize(address _baseImplementation, address _lumerin, address _feeRecipient, uint16 _validatorFeeRateScaled) returns()
func (_Clonefactory *ClonefactoryTransactorSession) Initialize(_baseImplementation common.Address, _lumerin common.Address, _feeRecipient common.Address, _validatorFeeRateScaled uint16) (*types.Transaction, error) {
	return _Clonefactory.Contract.Initialize(&_Clonefactory.TransactOpts, _baseImplementation, _lumerin, _feeRecipient, _validatorFeeRateScaled)
}
...
//
// Solidity: function setCreateNewRentalContract(uint256 _price, uint256 _limit, uint256 _speed, uint256 _length, address , string _pubKey) payable returns(address)
func (_Clonefactory *ClonefactoryTransactor) SetCreateNewRentalContract(opts *bind.TransactOpts, _price *big.Int, _limit *big.Int, _speed *big.Int, _length *big.Int, arg4 common.Address, _pubKey string) (*types.Transaction, error) {
	return _Clonefactory.contract.Transact(opts, "setCreateNewRentalContract", _price, _limit, _speed, _length, arg4, _pubKey)
}

// SetCreateNewRentalContract is a paid mutator transaction binding the contract method 0x86712686.
//
// Solidity: function setCreateNewRentalContract(uint256 _price, uint256 _limit, uint256 _speed, uint256 _length, address , string _pubKey) payable returns(address)
func (_Clonefactory *ClonefactorySession) SetCreateNewRentalContract(_price *big.Int, _limit *big.Int, _speed *big.Int, _length *big.Int, arg4 common.Address, _pubKey string) (*types.Transaction, error) {
	return _Clonefactory.Contract.SetCreateNewRentalContract(&_Clonefactory.TransactOpts, _price, _limit, _speed, _length, arg4, _pubKey)
}

// SetCreateNewRentalContract is a paid mutator transaction binding the contract method 0x86712686.
//
// Solidity: function setCreateNewRentalContract(uint256 _price, uint256 _limit, uint256 _speed, uint256 _length, address , string _pubKey) payable returns(address)
func (_Clonefactory *ClonefactoryTransactorSession) SetCreateNewRentalContract(_price *big.Int, _limit *big.Int, _speed *big.Int, _length *big.Int, arg4 common.Address, _pubKey string) (*types.Transaction, error) {
	return _Clonefactory.Contract.SetCreateNewRentalContract(&_Clonefactory.TransactOpts, _price, _limit, _speed, _length, arg4, _pubKey)
}

// SetCreateNewRentalContractV2 is a paid mutator transaction binding the contract method 0x2e1e8a93.
//
// Solidity: function setCreateNewRentalContractV2(uint256 _price, uint256 _limit, uint256 _speed, uint256 _length, int8 _profitTarget, address , string _pubKey) payable returns(address)
func (_Clonefactory *ClonefactoryTransactor) SetCreateNewRentalContractV2(opts *bind.TransactOpts, _price *big.Int, _limit *big.Int, _speed *big.Int, _length *big.Int, _profitTarget int8, arg5 common.Address, _pubKey string) (*types.Transaction, error) {
	return _Clonefactory.contract.Transact(opts, "setCreateNewRentalContractV2", _price, _limit, _speed, _length, _profitTarget, arg5, _pubKey)
}

// SetCreateNewRentalContractV2 is a paid mutator transaction binding the contract method 0x2e1e8a93.
//
// Solidity: function setCreateNewRentalContractV2(uint256 _price, uint256 _limit, uint256 _speed, uint256 _length, int8 _profitTarget, address , string _pubKey) payable returns(address)
func (_Clonefactory *ClonefactorySession) SetCreateNewRentalContractV2(_price *big.Int, _limit *big.Int, _speed *big.Int, _length *big.Int, _profitTarget int8, arg5 common.Address, _pubKey string) (*types.Transaction, error) {
	return _Clonefactory.Contract.SetCreateNewRentalContractV2(&_Clonefactory.TransactOpts, _price, _limit, _speed, _length, _profitTarget, arg5, _pubKey)
}

// SetCreateNewRentalContractV2 is a paid mutator transaction binding the contract method 0x2e1e8a93.
//
// Solidity: function setCreateNewRentalContractV2(uint256 _price, uint256 _limit, uint256 _speed, uint256 _length, int8 _profitTarget, address , string _pubKey) payable returns(address)
func (_Clonefactory *ClonefactoryTransactorSession) SetCreateNewRentalContractV2(_price *big.Int, _limit *big.Int, _speed *big.Int, _length *big.Int, _profitTarget int8, arg5 common.Address, _pubKey string) (*types.Transaction, error) {
	return _Clonefactory.Contract.SetCreateNewRentalContractV2(&_Clonefactory.TransactOpts, _price, _limit, _speed, _length, _profitTarget, arg5, _pubKey)
}
...
// SetValidatorFeeRate is a paid mutator transaction binding the contract method 0x3c6f878c.
//
// Solidity: function setValidatorFeeRate(uint16 _validatorFeeRateScaled) returns()
func (_Clonefactory *ClonefactoryTransactor) SetValidatorFeeRate(opts *bind.TransactOpts, _validatorFeeRateScaled uint16) (*types.Transaction, error) {
...
//
// Solidity: function setValidatorFeeRate(uint16 _validatorFeeRateScaled) returns()
func (_Clonefactory *ClonefactorySession) SetValidatorFeeRate(_validatorFeeRateScaled uint16) (*types.Transaction, error) {
...
//
// Solidity: function setValidatorFeeRate(uint16 _validatorFeeRateScaled) returns()
func (_Clonefactory *ClonefactoryTransactorSession) SetValidatorFeeRate(_validatorFeeRateScaled uint16) (*types.Transaction, error) {
	return _Clonefactory.Contract.SetValidatorFeeRate(&_Clonefactory.TransactOpts, _validatorFeeRateScaled)
}
