...
// EmptySlot1 is a free data retrieval call binding the contract method 0x1013b147.
//
// Solidity: function emptySlot1() view returns(uint8)
func (_Implementation *ImplementationCaller) EmptySlot1(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _Implementation.contract.Call(opts, &out, "emptySlot1")
...
//
// Solidity: function emptySlot1() view returns(uint8)
func (_Implementation *ImplementationSession) EmptySlot1() (uint8, error) {
	return _Implementation.Contract.EmptySlot1(&_Implementation.CallOpts)
}

// EmptySlot1 is a free data retrieval call binding the contract method 0x1013b147.
//
// Solidity: function emptySlot1() view returns(uint8)
func (_Implementation *ImplementationCallerSession) EmptySlot1() (uint8, error) {
	return _Implementation.Contract.EmptySlot1(&_Implementation.CallOpts)
}
...
// SetPurchaseContract is a paid mutator transaction binding the contract method 0x85f45a29.
//
// Solidity: function setPurchaseContract(string _encrValidatorURL, string _encrDestURL, address _buyer, address _validator) returns()
func (_Implementation *ImplementationTransactor) SetPurchaseContract(opts *bind.TransactOpts, _encrValidatorURL string, _encrDestURL string, _buyer common.Address, _validator common.Address) (*types.Transaction, error) {
	return _Implementation.contract.Transact(opts, "setPurchaseContract", _encrValidatorURL, _encrDestURL, _buyer, _validator)
}

// SetPurchaseContract is a paid mutator transaction binding the contract method 0x85f45a29.
//
// Solidity: function setPurchaseContract(string _encrValidatorURL, string _encrDestURL, address _buyer, address _validator) returns()
func (_Implementation *ImplementationSession) SetPurchaseContract(_encrValidatorURL string, _encrDestURL string, _buyer common.Address, _validator common.Address) (*types.Transaction, error) {
	return _Implementation.Contract.SetPurchaseContract(&_Implementation.TransactOpts, _encrValidatorURL, _encrDestURL, _buyer, _validator)
}

// SetPurchaseContract is a paid mutator transaction binding the contract method 0x85f45a29.
//
// Solidity: function setPurchaseContract(string _encrValidatorURL, string _encrDestURL, address _buyer, address _validator) returns()
func (_Implementation *ImplementationTransactorSession) SetPurchaseContract(_encrValidatorURL string, _encrDestURL string, _buyer common.Address, _validator common.Address) (*types.Transaction, error) {
	return _Implementation.Contract.SetPurchaseContract(&_Implementation.TransactOpts, _encrValidatorURL, _encrDestURL, _buyer, _validator)
}
...
//
// Solidity: event closedEarly(uint8 reason)
