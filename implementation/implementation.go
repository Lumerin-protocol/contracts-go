...
//
// Solidity: function futureTerms() view returns(uint256 _price, uint256 _limit, uint256 _speed, uint256 _length)
...
//
// Solidity: function getPublicVariables() view returns(uint8 _state, uint256 _price, uint256 _limit, uint256 _speed, uint256 _length, uint256 _startingBlockTimestamp, address _buyer, address _seller, string _encryptedPoolData, bool _isDeleted, uint256 _balance, bool _hasFutureTerms)
...
//
// Solidity: function terms() view returns(uint256 _price, uint256 _limit, uint256 _speed, uint256 _length)
