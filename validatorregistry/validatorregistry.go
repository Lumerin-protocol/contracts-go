...
//
// Solidity: function getValidator(address addr) view returns((uint256,address,address,uint8,string))
...
//
// Solidity: function validators(address ) view returns(uint256 stake, address addr, address lastComplainer, uint8 complains, string host)
func (_Validatorregistry *ValidatorregistryCaller) Validators(opts *bind.CallOpts, arg0 common.Address) (struct {
	...
	outstruct.LastComplainer = *abi.ConvertType(out[2], new(common.Address)).(*common.Address)
	outstruct.Complains = *abi.ConvertType(out[3], new(uint8)).(*uint8)
	outstruct.Host = *abi.ConvertType(out[4], new(string)).(*string)
...
// ValidatorRegister is a paid mutator transaction binding the contract method 0x815f7ac1.
//
// Solidity: function validatorRegister(uint256 stake, string host) returns()
func (_Validatorregistry *ValidatorregistryTransactor) ValidatorRegister(opts *bind.TransactOpts, stake *big.Int, host string) (*types.Transaction, error) {
	return _Validatorregistry.contract.Transact(opts, "validatorRegister", stake, host)
}

// ValidatorRegister is a paid mutator transaction binding the contract method 0x815f7ac1.
//
// Solidity: function validatorRegister(uint256 stake, string host) returns()
func (_Validatorregistry *ValidatorregistrySession) ValidatorRegister(stake *big.Int, host string) (*types.Transaction, error) {
	return _Validatorregistry.Contract.ValidatorRegister(&_Validatorregistry.TransactOpts, stake, host)
}

// ValidatorRegister is a paid mutator transaction binding the contract method 0x815f7ac1.
//
// Solidity: function validatorRegister(uint256 stake, string host) returns()
func (_Validatorregistry *ValidatorregistryTransactorSession) ValidatorRegister(stake *big.Int, host string) (*types.Transaction, error) {
	return _Validatorregistry.Contract.ValidatorRegister(&_Validatorregistry.TransactOpts, stake, host)
}
