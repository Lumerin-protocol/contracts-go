...
// GetMaintenanceMarginForPosition is a free data retrieval call binding the contract method 0x397f849d.
//
// Solidity: function getMaintenanceMarginForPosition(uint256 _entryPricePerDay, int256 _qty) view returns(uint256)
func (_Futures *FuturesCaller) GetMaintenanceMarginForPosition(opts *bind.CallOpts, _entryPricePerDay *big.Int, _qty *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Futures.contract.Call(opts, &out, "getMaintenanceMarginForPosition", _entryPricePerDay, _qty)
...
//
// Solidity: function getMaintenanceMarginForPosition(uint256 _entryPricePerDay, int256 _qty) view returns(uint256)
func (_Futures *FuturesSession) GetMaintenanceMarginForPosition(_entryPricePerDay *big.Int, _qty *big.Int) (*big.Int, error) {
	return _Futures.Contract.GetMaintenanceMarginForPosition(&_Futures.CallOpts, _entryPricePerDay, _qty)
}

// GetMaintenanceMarginForPosition is a free data retrieval call binding the contract method 0x397f849d.
//
// Solidity: function getMaintenanceMarginForPosition(uint256 _entryPricePerDay, int256 _qty) view returns(uint256)
func (_Futures *FuturesCallerSession) GetMaintenanceMarginForPosition(_entryPricePerDay *big.Int, _qty *big.Int) (*big.Int, error) {
	return _Futures.Contract.GetMaintenanceMarginForPosition(&_Futures.CallOpts, _entryPricePerDay, _qty)
}

// GetMarginPercent is a free data retrieval call binding the contract method 0x793a087e.
//
// Solidity: function getMarginPercent() view returns(uint8)
func (_Futures *FuturesCaller) GetMarginPercent(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _Futures.contract.Call(opts, &out, "getMarginPercent")
...
//
// Solidity: function getMarginPercent() view returns(uint8)
func (_Futures *FuturesSession) GetMarginPercent() (uint8, error) {
	return _Futures.Contract.GetMarginPercent(&_Futures.CallOpts)
}

// GetMarginPercent is a free data retrieval call binding the contract method 0x793a087e.
//
// Solidity: function getMarginPercent() view returns(uint8)
func (_Futures *FuturesCallerSession) GetMarginPercent() (uint8, error) {
	return _Futures.Contract.GetMarginPercent(&_Futures.CallOpts)
}
...
// DepositDeliveryPayment is a paid mutator transaction binding the contract method 0xe947cc3e.
//
// Solidity: function depositDeliveryPayment(uint256 _amount, uint256 _deliveryDate) returns(bool)
func (_Futures *FuturesTransactor) DepositDeliveryPayment(opts *bind.TransactOpts, _amount *big.Int, _deliveryDate *big.Int) (*types.Transaction, error) {
	return _Futures.contract.Transact(opts, "depositDeliveryPayment", _amount, _deliveryDate)
}

// DepositDeliveryPayment is a paid mutator transaction binding the contract method 0xe947cc3e.
//
// Solidity: function depositDeliveryPayment(uint256 _amount, uint256 _deliveryDate) returns(bool)
func (_Futures *FuturesSession) DepositDeliveryPayment(_amount *big.Int, _deliveryDate *big.Int) (*types.Transaction, error) {
	return _Futures.Contract.DepositDeliveryPayment(&_Futures.TransactOpts, _amount, _deliveryDate)
}

// DepositDeliveryPayment is a paid mutator transaction binding the contract method 0xe947cc3e.
//
// Solidity: function depositDeliveryPayment(uint256 _amount, uint256 _deliveryDate) returns(bool)
func (_Futures *FuturesTransactorSession) DepositDeliveryPayment(_amount *big.Int, _deliveryDate *big.Int) (*types.Transaction, error) {
	return _Futures.Contract.DepositDeliveryPayment(&_Futures.TransactOpts, _amount, _deliveryDate)
}
