...
// ValidatorURL is a free data retrieval call binding the contract method 0xe80fc775.
//
// Solidity: function validatorURL() view returns(string)
func (_Futures *FuturesCaller) ValidatorURL(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Futures.contract.Call(opts, &out, "validatorURL")
...
//
// Solidity: function validatorURL() view returns(string)
func (_Futures *FuturesSession) ValidatorURL() (string, error) {
	return _Futures.Contract.ValidatorURL(&_Futures.CallOpts)
}

// ValidatorURL is a free data retrieval call binding the contract method 0xe80fc775.
//
// Solidity: function validatorURL() view returns(string)
func (_Futures *FuturesCallerSession) ValidatorURL() (string, error) {
	return _Futures.Contract.ValidatorURL(&_Futures.CallOpts)
}
...
// SetValidatorURL is a paid mutator transaction binding the contract method 0x19250cde.
//
// Solidity: function setValidatorURL(string _validatorURL) returns()
func (_Futures *FuturesTransactor) SetValidatorURL(opts *bind.TransactOpts, _validatorURL string) (*types.Transaction, error) {
	return _Futures.contract.Transact(opts, "setValidatorURL", _validatorURL)
}

// SetValidatorURL is a paid mutator transaction binding the contract method 0x19250cde.
//
// Solidity: function setValidatorURL(string _validatorURL) returns()
func (_Futures *FuturesSession) SetValidatorURL(_validatorURL string) (*types.Transaction, error) {
	return _Futures.Contract.SetValidatorURL(&_Futures.TransactOpts, _validatorURL)
}

// SetValidatorURL is a paid mutator transaction binding the contract method 0x19250cde.
//
// Solidity: function setValidatorURL(string _validatorURL) returns()
func (_Futures *FuturesTransactorSession) SetValidatorURL(_validatorURL string) (*types.Transaction, error) {
	return _Futures.Contract.SetValidatorURL(&_Futures.TransactOpts, _validatorURL)
}
...
// FuturesValidatorURLUpdatedIterator is returned from FilterValidatorURLUpdated and is used to iterate over the raw logs and unpacked data for ValidatorURLUpdated events raised by the Futures contract.
type FuturesValidatorURLUpdatedIterator struct {
	Event *FuturesValidatorURLUpdated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *FuturesValidatorURLUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(FuturesValidatorURLUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *FuturesValidatorURLUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *FuturesValidatorURLUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// FuturesValidatorURLUpdated represents a ValidatorURLUpdated event raised by the Futures contract.
type FuturesValidatorURLUpdated struct {
	ValidatorURL string
	Raw          types.Log // Blockchain specific contextual infos
}

// FilterValidatorURLUpdated is a free log retrieval operation binding the contract event 0xfbe0ef9d05dfd67706ac8233d80698eb0969fabd0b1561d32baa2427c898209d.
//
// Solidity: event ValidatorURLUpdated(string validatorURL)
func (_Futures *FuturesFilterer) FilterValidatorURLUpdated(opts *bind.FilterOpts) (*FuturesValidatorURLUpdatedIterator, error) {

	logs, sub, err := _Futures.contract.FilterLogs(opts, "ValidatorURLUpdated")
	if err != nil {
		return nil, err
	}
	return &FuturesValidatorURLUpdatedIterator{contract: _Futures.contract, event: "ValidatorURLUpdated", logs: logs, sub: sub}, nil
}

// WatchValidatorURLUpdated is a free log subscription operation binding the contract event 0xfbe0ef9d05dfd67706ac8233d80698eb0969fabd0b1561d32baa2427c898209d.
//
// Solidity: event ValidatorURLUpdated(string validatorURL)
func (_Futures *FuturesFilterer) WatchValidatorURLUpdated(opts *bind.WatchOpts, sink chan<- *FuturesValidatorURLUpdated) (event.Subscription, error) {

	logs, sub, err := _Futures.contract.WatchLogs(opts, "ValidatorURLUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(FuturesValidatorURLUpdated)
				if err := _Futures.contract.UnpackLog(event, "ValidatorURLUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseValidatorURLUpdated is a log parse operation binding the contract event 0xfbe0ef9d05dfd67706ac8233d80698eb0969fabd0b1561d32baa2427c898209d.
//
// Solidity: event ValidatorURLUpdated(string validatorURL)
func (_Futures *FuturesFilterer) ParseValidatorURLUpdated(log types.Log) (*FuturesValidatorURLUpdated, error) {
	event := new(FuturesValidatorURLUpdated)
	if err := _Futures.contract.UnpackLog(event, "ValidatorURLUpdated", log); err != nil {
		return nil, err
	}
