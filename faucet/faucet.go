...
var FaucetMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_lmr\",\"type\":\"address\"}],\"stateMutability\":\"payable\",\"type\":\"constructor\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_address\",\"type\":\"address\"},{\"internalType\":\"string\",\"name\":\"_ipAddress\",\"type\":\"string\"}],\"name\":\"canClaimTokens\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"cooldownPeriod\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"dailyLimitCount\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"dailyLimitMax\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"emptyGeth\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"gethAmount\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"resetTodaysLimit\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_to\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"_amount\",\"type\":\"uint256\"}],\"name\":\"setTransferLumerin\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"_cooldownPeriod\",\"type\":\"uint256\"}],\"name\":\"setUpdateCooldownPeriod\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"_dailyLimitMax\",\"type\":\"uint256\"}],\"name\":\"setUpdateDailyLimit\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"_gwei\",\"type\":\"uint256\"}],\"name\":\"setUpdateGWEIAmount\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_lmr\",\"type\":\"address\"}],\"name\":\"setUpdateLumerin\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_newOwner\",\"type\":\"address\"}],\"name\":\"setUpdateOwner\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"_txAmount\",\"type\":\"uint256\"}],\"name\":\"setUpdateTxAmount\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"startOfDay\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_claiment\",\"type\":\"address\"},{\"internalType\":\"string\",\"name\":\"_ipAddress\",\"type\":\"string\"}],\"name\":\"supervisedClaim\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"txAmount\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"stateMutability\":\"payable\",\"type\":\"receive\"}]",
}
...
// DailyLimitMax is a free data retrieval call binding the contract method 0xbfa10c05.
//
// Solidity: function dailyLimitMax() view returns(uint256)
func (_Faucet *FaucetCaller) DailyLimitMax(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Faucet.contract.Call(opts, &out, "dailyLimitMax")
...
//
// Solidity: function dailyLimitMax() view returns(uint256)
func (_Faucet *FaucetSession) DailyLimitMax() (*big.Int, error) {
	return _Faucet.Contract.DailyLimitMax(&_Faucet.CallOpts)
}

// DailyLimitMax is a free data retrieval call binding the contract method 0xbfa10c05.
//
// Solidity: function dailyLimitMax() view returns(uint256)
func (_Faucet *FaucetCallerSession) DailyLimitMax() (*big.Int, error) {
	return _Faucet.Contract.DailyLimitMax(&_Faucet.CallOpts)
}
...
// ResetTodaysLimit is a paid mutator transaction binding the contract method 0xd2ea3006.
//
// Solidity: function resetTodaysLimit() returns()
func (_Faucet *FaucetTransactor) ResetTodaysLimit(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Faucet.contract.Transact(opts, "resetTodaysLimit")
}

// ResetTodaysLimit is a paid mutator transaction binding the contract method 0xd2ea3006.
//
// Solidity: function resetTodaysLimit() returns()
func (_Faucet *FaucetSession) ResetTodaysLimit() (*types.Transaction, error) {
	return _Faucet.Contract.ResetTodaysLimit(&_Faucet.TransactOpts)
}

// ResetTodaysLimit is a paid mutator transaction binding the contract method 0xd2ea3006.
//
// Solidity: function resetTodaysLimit() returns()
func (_Faucet *FaucetTransactorSession) ResetTodaysLimit() (*types.Transaction, error) {
	return _Faucet.Contract.ResetTodaysLimit(&_Faucet.TransactOpts)
}
...
// SetUpdateDailyLimit is a paid mutator transaction binding the contract method 0x01148ade.
//
// Solidity: function setUpdateDailyLimit(uint256 _dailyLimitMax) returns()
func (_Faucet *FaucetTransactor) SetUpdateDailyLimit(opts *bind.TransactOpts, _dailyLimitMax *big.Int) (*types.Transaction, error) {
	return _Faucet.contract.Transact(opts, "setUpdateDailyLimit", _dailyLimitMax)
}

// SetUpdateDailyLimit is a paid mutator transaction binding the contract method 0x01148ade.
//
// Solidity: function setUpdateDailyLimit(uint256 _dailyLimitMax) returns()
func (_Faucet *FaucetSession) SetUpdateDailyLimit(_dailyLimitMax *big.Int) (*types.Transaction, error) {
	return _Faucet.Contract.SetUpdateDailyLimit(&_Faucet.TransactOpts, _dailyLimitMax)
}

// SetUpdateDailyLimit is a paid mutator transaction binding the contract method 0x01148ade.
//
// Solidity: function setUpdateDailyLimit(uint256 _dailyLimitMax) returns()
func (_Faucet *FaucetTransactorSession) SetUpdateDailyLimit(_dailyLimitMax *big.Int) (*types.Transaction, error) {
	return _Faucet.Contract.SetUpdateDailyLimit(&_Faucet.TransactOpts, _dailyLimitMax)
}
